...
-- Les SavedVariables de Vanilla ne sont garanties disponibles qu'apres
-- VARIABLES_LOADED. La reference est donc affectee pendant l'initialisation,
-- sinon elle peut continuer a pointer vers la table vide creee ci-dessus.
local db
